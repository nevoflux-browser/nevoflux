...
export class NevofluxChild extends JSWindowActorChild {
  ...
  async click({ selector, button = 'left', clickCount = 1, delay = 0, force = false }) {
    ...
    try {
      ...
      console.log(
        '[NevofluxChild.click] windowUtils available:',
        !!domUtils,
        'sendMouseEvent:',
        typeof domUtils?.sendMouseEvent
      );
      ...
      if (domUtils && typeof domUtils.sendMouseEvent === 'function') {
        console.log(
          '[NevofluxChild.click] Using windowUtils.sendMouseEvent at',
          clickPoint.x,
          clickPoint.y
        );
    ...
    console.log(
      '[NevofluxChild.click] Complete - domChanged:',
      domChanged,
      'networkRequest:',
      networkRequestMade,
      'elementRemoved:',
      !doc.body?.contains(el),
      'effective:',
      clickEffective
    );
