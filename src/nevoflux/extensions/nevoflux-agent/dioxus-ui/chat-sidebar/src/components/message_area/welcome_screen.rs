    ...
    let handle_click = move |_| {
        ...
        wasm_bindgen_futures::spawn_local(async move {
            ...
            if mock_enabled {
                ...
                if let Err(e) = crate::messaging::send_chat_message(&session_id, text, vec![], Some(tab_id)).await {
