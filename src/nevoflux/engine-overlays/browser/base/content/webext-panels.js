...
function getBrowser(panel) {
  ...
  const initBrowser = () => {
    // NevoFlux: Guard against null messageManager during remoteness changes.
    // On macOS, DidChangeBrowserRemoteness can fire before the new
    // messageManager is ready, causing a TypeError.
