...
4. Use expectation scores as secondary evidence
...
{
  "winner": "A",
  "reasoning": "Output A provides a complete solution with proper formatting. Output B is missing fields and has inconsistencies.",
  "rubric": {
    "A": {
